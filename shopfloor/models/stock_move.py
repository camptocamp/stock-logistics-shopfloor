...
class StockMove(models.Model):
    ...
    def _extract_in_split_order(self, default=None, backorder=False):
        ...
        # some cases, the batch may contain done pickings, which would make the sanity
        # check fail. This could be the case when using the cluster_picking
        # set_destination_all method, when the batch contains lines partially processed
        # from different pickings.

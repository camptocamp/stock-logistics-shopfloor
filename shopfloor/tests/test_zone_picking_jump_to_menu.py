...
class ZonePickingJumpToMenu(ZonePickingCommonCase):
    ...
    def assert_response_jump_to_menu(self, response, menu, state_data={}, message=None):
        data = {
            "next_state":"start",
            "menu_id":menu.id,
        }
    ...
    def test_set_destination_location_jump_to(self):
        self.service.work.menu.sudo().jump_to_menu_id = self.menu2
        self.service.work.menu.sudo().jump_to_menu_zone_picking_unload_all = self.menu2
